...
// 1. Custom Status Indicators: Add fields to the State struct below
// 2. Custom Event Handling: Subscribe to events in the load() method
// 3. Custom Rendering: Modify the render() method to display your status
// 4. Custom Keybindings: See src/first_line.rs and src/second_line.rs
// 5. Custom Tips: See src/tip/data/ directory
//
// For detailed instructions, see: ../STATUS_BAR_CUSTOMIZATION.md
...
// CUSTOMIZATION: Add your custom status fields here
// Example:
//   custom_git_status: Option<String>,
//   custom_build_status: Option<String>,
//   custom_indicator: bool,
#[derive(Default)]
struct State {
    tabs: Vec<TabInfo>,
    mode_info: ModeInfo,
...
impl ZellijPlugin for State {
    fn load(&mut self, configuration: BTreeMap<String, String>) {
        ...
        // CUSTOMIZATION: Add custom event types here if needed
        // Available event types can be found in zellij_tile::prelude::EventType
        subscribe(&[
    ...
    fn render(&mut self, rows: usize, cols: usize) {
        // CUSTOMIZATION: Add your custom status rendering here
        // You can print custom status information using print!() or println!()
        // Example: print!("Custom status: {}", self.custom_status);
        ...
        if let Some(copy_destination) = self.text_copy_destination {
            ...
            if active_tab.is_fullscreen_active {
                match self.mode_info.mode {
                    ...
                    _ => keybinds(&self.mode_info, cols),
                }
