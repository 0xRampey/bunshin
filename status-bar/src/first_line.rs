// CUSTOMIZATION: Modify keybindings and shortcuts displayed in the first line (top bar)
// See the public functions:
//   - first_line() - Main rendering function
//   - key_indicators() - Shows available key shortcuts in current mode
//   - change_mode_quick_list() - Shows mode-specific quick actions
